...
chkPeri = Checkbutton(dlgBox, text="Perimeter", variable=iPeri).place(x=30, y=90)
chkArea = Checkbutton(dlgBox, text="Area", variable=iArea).place(x=100, y=90)
chkEccen = Checkbutton(dlgBox, text="Eccentricity", variable=iEccen).place(x=150, y=90)
